...
namespace SYJMA.Umbraco.Utility
{
    ...
    public struct CONSTVALUE
    {
        ...
        public static readonly string GET_YEARGROUP = DOMAIN + "LookupValue?lookupname=yeargroup&bomtype=tour";
        public static readonly string GET_SUBJECTAREA = DOMAIN + "LookupValue?lookupname=subjectarea&bomtype=tour";
